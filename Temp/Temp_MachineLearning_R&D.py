...
country = "croatia" #South Africa, morocco, ALL
...
def stemdoc (doc, deacc=True, lowercase=True, errors="strict"):
    stemmer = SnowballStemmer("english")
    for token in utils.tokenize(doc, lowercase=lowercase, deacc=deacc, errors=errors):
        yield stemmer.stem(token)

def parsedoc (doc, deacc=True, lowercase=True, errors="strict"):
    for token in utils.tokenize(doc, lowercase=lowercase, deacc=deacc, errors=errors):
        yield token
...
def simple_preprocess(doc, deacc=True, lowercase=True, errors='ignore',stopwords=longstopwords()):
    ...
    for token in parsedoc(doc, lowercase=lowercase, deacc=deacc, errors=errors):
